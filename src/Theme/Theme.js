...
export const COLORS = {
    ...
    primary: "#F24405",
    // secondary: "#15081f",
    primaryBorder:"rgba(255,191,0,0.58)",
    secondary:"rgba(78,58,0,0.93)",
...
export const FONTS = {
    ...
    body3: { fontFamily: "Poppins-Medium", fontSize: SIZES.body3,lineHeight:30,padding: 0 },
    body4: { fontFamily: "Poppins-Medium", fontSize: SIZES.body4,padding:0 },
